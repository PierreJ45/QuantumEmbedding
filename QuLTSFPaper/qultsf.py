...
model_dict = {'DLinear': DLinear, 'NLinear': NLinear, 'Linear': Linear, 'QuLTSF': QuLTSF}

config = {
    "model_name": "QuLTSF",  # options: [QuLTSF, Linear, DLinear, NLinear]
    ...
    "num_qubits": 5,
    "QML_device": "default.qubit",  # options: [default.qubit, lightning.gpu, lightning.qubit]
    "num_layers": 2,  # Number of quantum layers
    "diff_method": "best", # options: [parameter-shift, adjoint, best]
...
setting = (
    ...
    f"nq{config['num_qubits']}_nl{config['num_layers']}_"
